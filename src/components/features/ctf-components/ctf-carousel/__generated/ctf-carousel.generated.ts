...
export type CtfCarouselQueryVariables = Types.Exact<{
...
export type CtfCarouselQuery = { __typename?: 'Query', carousel?: (
    { __typename?: 'Carousel' }
    & CarouselFieldsFragment
  ) | null };
...
export const CardFieldsFragmentDoc = `
  ...
  cardContent {
    ...
    `;
export const CarouselFieldsFragmentDoc = `
  ...
  cardsCollection(limit: 10) {
    ...
    `;
export const CtfCarouselDocument = `
    query CtfCarousel($id: String!, $locale: String, $preview: Boolean) {
  carousel(id: $id, locale: $locale, preview: $preview) {
    ...CarouselFields
  }
}
...
export const useCtfCarouselQuery = <
      ...
      TError = unknown
    >(
      variables: CtfCarouselQueryVariables,
      options?: Omit<UseQueryOptions<CtfCarouselQuery, TError, TData>, 'queryKey'> & { queryKey?: UseQueryOptions<CtfCarouselQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useQuery<CtfCarouselQuery, TError, TData>(
      {
    queryKey: ['CtfCarousel', variables],
    queryFn: customFetcher<CtfCarouselQuery, CtfCarouselQueryVariables>(CtfCarouselDocument, variables),
    ...options
  }
    )};

useCtfCarouselQuery.getKey = (variables: CtfCarouselQueryVariables) => ['CtfCarousel', variables];


useCtfCarouselQuery.fetcher = (variables: CtfCarouselQueryVariables, options?: RequestInit['headers']) => customFetcher<CtfCarouselQuery, CtfCarouselQueryVariables>(CtfCarouselDocument, variables, options);
